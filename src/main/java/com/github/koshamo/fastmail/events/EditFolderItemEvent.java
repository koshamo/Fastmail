 ...
 *
 */
public class EditFolderItemEvent extends DataEvent<FolderItemMeta, String> {
	 ...
	 * @param data
	 */
	public EditFolderItemEvent(EventHandler source, EventHandler target, FolderItemMeta meta, String data) {
